...
LRESULT ImGUIWndProc(UINT uMsg, WPARAM wParam, LPARAM lParam) {
...
static LRESULT WINAPI WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    LRESULT WndProcRes = ImGUIWndProc(uMsg, wParam, lParam);

    // prevent in-game interactions whilst menu open
    if (Menu::showMenu && WndProcRes) {
        return 1L;
    }
